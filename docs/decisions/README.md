...
whatever the corpus and the provenance gate produce. As of this writing that is 127 loaded entries
across 33 papers; see `docs/limitations.md` §1–2 for the coverage this leaves skewed, and
